...
SensorMatrix Geometry::createConfiguredSensor(glm::vec3 size_XZY, glm::vec3 origin_XZY,
    ...
    // Keep every mode on the same physical field of view. The integer voxel
    // grid may include padded boundary cells and must not resize the camera.
    return createSensor(m_sensorSceneSize_XZY, origin_XZY, vza, vaa, ratio);
}
...
// ================= HexebIO overloads (identical implementation to VoxelebIO) =================
bool Geometry::createGeometry(std::shared_ptr<FileIO> &fileio, std::shared_ptr<HexebIO> &modelio){
...
void Geometry::updateAngle(std::shared_ptr<HexebIO> &modelio, int kangle){
...
void Geometry::updateSensor( std::shared_ptr<HexebIO> &modelio, SensorMatrix &sensor){
...
void Geometry::updateLight(std::shared_ptr<HexebIO> &modelio, LightSet &light){
...
void Geometry::updateSolarAngle(std::shared_ptr<HexebIO> &modelio, Angle &angle) {
    SPACalc spa;
    spa_data data;
...
void Geometry::orthcorrect(std::shared_ptr<HexebIO> &modelio,float vza, float vaa,
                           Eigen::VectorXd &cx, Eigen::VectorXd &cy) {
...
// ================= HexrtIO overloads (identical implementation to VoxelrtIO) =================
bool Geometry::createGeometry(std::shared_ptr<FileIO> &fileio, std::shared_ptr<HexrtIO> &modelio){
...
void Geometry::updateAngle(std::shared_ptr<HexrtIO> &modelio, int kangle){
...
void Geometry::updateSensorPos(std::shared_ptr<HexrtIO> &modelio, int kpos){
...
void Geometry::updateSensor( std::shared_ptr<HexrtIO> &modelio, SensorMatrix &sensor){
...
void Geometry::updateLight(std::shared_ptr<HexrtIO> &modelio, LightSet &light){
...
void Geometry::orthcorrect(std::shared_ptr<HexrtIO> &modelio,float vza, float vaa,
                           Eigen::VectorXd &cx, Eigen::VectorXd &cy) {
