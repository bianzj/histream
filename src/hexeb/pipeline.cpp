...
void Pipeline::createShaderBindingTable(std::shared_ptr<HexebIO> &modelio)
{
...
bool Pipeline::createPipeline(std::shared_ptr<HexebIO> &modelio)
{
    ...
    std::map<VoxelEBStage, std::string> VoxellstPaths{
            {VoxelEBStage::gap,         baseDirectory + "/shader/hexeb/voxelrad_solar.comp.spv"},
            {VoxelEBStage::directVNIR,  baseDirectory + "/shader/hexeb/voxelrad_direct_VNIR.comp.spv"},
            {VoxelEBStage::directTIR,   baseDirectory + "/shader/hexeb/voxelrad_direct_TIR.comp.spv"},
            {VoxelEBStage::diffuseVNIR, baseDirectory + "/shader/hexeb/voxelrad_diffuse_VNIR_single.comp.spv"},
            {VoxelEBStage::diffuseTIR,  baseDirectory + "/shader/hexeb/voxelrad_diffuse_TIR_single.comp.spv"},
            {VoxelEBStage::budget,      baseDirectory + "/shader/hexeb/budget.comp.spv"},
            {VoxelEBStage::evapo,       baseDirectory + "/shader/hexeb/evapo.comp.spv"},
            {VoxelEBStage::updateTp,    baseDirectory + "/shader/hexeb/updateTp.comp.spv"},
            {VoxelEBStage::updateL,     baseDirectory + "/shader/hexeb/updateL.comp.spv"},
            {VoxelEBStage::aero,        baseDirectory + "/shader/hexeb/aeresist.comp.spv"},
            //{VoxelEBStage::bio,         baseDirectory + "/shader/hexeb/biochemical_m12.comp.spv"},
             {VoxelEBStage::bio,         baseDirectory + "/shader/hexeb/biochemical.comp.spv"},
            {VoxelEBStage::out,         baseDirectory + "/shader/hexeb/voxelrad_image.comp.spv"}};
...
//
//bool Pipeline::createRTPipeline(std::shared_ptr<HexebIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
//            {VoxelRadStage::gap, baseDirectory + "/shader/Hexeb/voxelrad_solar.comp.spv"},
//            {VoxelRadStage::directVNIR, baseDirectory + "/shader/Hexeb/voxelrad_direct_VNIR.comp.spv"},
//            {VoxelRadStage::directTIR, baseDirectory + "/shader/Hexeb/voxelrad_direct_TIR.comp.spv"},
//            {VoxelRadStage::diffuseVNIR, baseDirectory + "/shader/Hexeb/voxelrad_diffuse_VNIR_single.comp.spv"},
//            {VoxelRadStage::diffuseTIR, baseDirectory + "/shader/Hexeb/voxelrad_diffuse_TIR_single.comp.spv"},
//            };
//
//
...
//
//
//bool Pipeline::createETPipeline(std::shared_ptr<HexebIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
//
//
//bool Pipeline::createEBPipeline(std::shared_ptr<HexebIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
//
//
//bool Pipeline::createAeroPipeline(std::shared_ptr<HexebIO> &modelio)
//{
//
//    auto & m_device = modelio->m_device;
//    auto & m_pipelineLayout = modelio->m_pipelineLayout_et;
...
//
//
//bool Pipeline::createBioPipeline(std::shared_ptr<HexebIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
void Pipeline::destroy(std::shared_ptr<HexebIO> &modelio) {
