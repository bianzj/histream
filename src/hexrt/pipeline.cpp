...
void Pipeline::createShaderBindingTable(std::shared_ptr<HexrtIO> &modelio)
{

}

bool Pipeline::createPipeline(std::shared_ptr<HexrtIO> &modelio)
{
    ...
    std::map<VoxelRTStage, std::string> VoxelrtPaths{
            {VoxelRTStage::gap,         baseDirectory + "/shader/hexrt/voxelrad_solar.comp.spv"},
            {VoxelRTStage::diffuse,  baseDirectory + "/shader/hexrt/voxelrad_diffuse_single.comp.spv"},
            {VoxelRTStage::out,         baseDirectory + "/shader/hexrt/voxelrad_image.comp.spv"}};


    if (access(VoxelrtPaths[VoxelRTStage::gap].c_str(), 0) == -1)
    {
...
//
//bool Pipeline::createRTPipeline(std::shared_ptr<HexrtIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
//
//
//bool Pipeline::createETPipeline(std::shared_ptr<HexrtIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
//
//
//bool Pipeline::createEBPipeline(std::shared_ptr<HexrtIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
//
//
//bool Pipeline::createAeroPipeline(std::shared_ptr<HexrtIO> &modelio)
//{
//
//    auto & m_device = modelio->m_device;
//    auto & m_pipelineLayout = modelio->m_pipelineLayout_et;
...
//
//
//bool Pipeline::createBioPipeline(std::shared_ptr<HexrtIO> &modelio)
//{
//
//
//    auto & m_device = modelio->m_device;
...
void Pipeline::destroy(std::shared_ptr<HexrtIO> &modelio) {
