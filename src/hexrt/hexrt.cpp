...
bool Hexrt::setup(AppSetting &appsetting, std::shared_ptr<HexrtIO> &modelio){
...
bool Hexrt::upload(std::shared_ptr<FileIO> &fileio, std::shared_ptr<HexrtIO> &modelio){
    ...
    // hex: 在场景构建前开启异质性体元计算 (createObjFilledVoxels 据此
    // 逐 OBJ 计算 (Ax, Ay, Az, rho) 并写入 VoxelIO::voxelHexs / VoxelLink::hexId)
...
bool Hexrt::uploadSetting(std::shared_ptr<FileIO> &fileio, std::shared_ptr<HexrtIO> &modelio) {
...
bool Hexrt::updateSetting(std::shared_ptr<HexrtIO> &modelio){
...
bool Hexrt::uploadDefined(std::shared_ptr<FileIO> &fileio, std::shared_ptr<HexrtIO> &modelio)
{
...
bool Hexrt::create(std::shared_ptr<HexrtIO> &modelio) {
...
bool Hexrt::run(std::shared_ptr<HexrtIO> &modelio, std::shared_ptr<FileIO> &fileio) {
...
bool Hexrt::destroy(std::shared_ptr<HexrtIO> & modelio){
...
void Hexrt::output(std::shared_ptr<HexrtIO> &modelio, std::shared_ptr<FileIO> &fileio, int knode, int kangle) {
...
void Hexrt::outputPos(std::shared_ptr<HexrtIO> &modelio, std::shared_ptr<FileIO> &fileio, int knode, int kpos) {
    VkBufferUsageFlags usage{VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT};
    const int width = modelio->imageSize.x;
    const int height = modelio->imageSize.y;
    const int nWave = modelio->n_wave;
...
void Hexrt::outputVoxel(std::shared_ptr<HexrtIO> &modelio, std::shared_ptr<FileIO> &fileio) {
...
//bool Hexrt::uploadAero(std::shared_ptr<FileIO> &fileio, std::shared_ptr<HexrtIO> &modelio) {
//
//
