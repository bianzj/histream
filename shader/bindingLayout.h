...
layout(binding = B_HEX) buffer _bufferMedium { VoxelHex voxelHexs[]; };
...
// ============================================================================
// HEXRT: 异质性体元 (hex voxel) 辐射管线 (ray tracing 版)
// 与 VOXELRT 相同, 另加 binding 16: 每个体元的 (Ax, Ay, Az, rho)
// ============================================================================
#ifdef HEXRT
...
layout(binding = B_STORAGE) buffer _bufferstorage { float outImage[]; };
layout(binding = B_LAD) buffer  _LAD{float lads[];};
// 异质性体元参数: VoxelLink.hexId -> voxelHexs[hexId]
...
// ============================================================================
// HEXEB: 异质性体元 (hex voxel) 能量平衡管线 (voxel list 版)
// 与 VOXELLST 相同, 另加 binding 31: 每个体元的 (Ax, Ay, Az, rho)
// ============================================================================
#ifdef HEXEB
